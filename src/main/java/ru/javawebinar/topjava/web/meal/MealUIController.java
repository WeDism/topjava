...
public class MealUIController extends AbstractMealController {
    ...
    @PostMapping
    @ResponseStatus(HttpStatus.NO_CONTENT)
    public void createMeal(@DateTimeFormat(iso = DateTimeFormat.ISO.DATE_TIME) LocalDateTime dateTime, @RequestParam String description, @RequestParam int calories) {
