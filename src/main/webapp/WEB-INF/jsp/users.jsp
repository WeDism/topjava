    ...
    <div class="container">
        ...
        <table class="table table-striped" id="datatable">
            ...
            <c:forEach items="${requestScope.users}" var="user">
                ...
                <tr id="${user.id}"
                        <c:choose>
                            <c:when test="${!user.enabled}">style="background-color: lightcoral"</c:when>
                            <c:otherwise>style="background-color: lightgreen"</c:otherwise>
                        </c:choose>/>
                ...
                <td><input type="checkbox"
                           ...
                           onclick="updateUserStatus(this, ${user.id})"
                </td>
