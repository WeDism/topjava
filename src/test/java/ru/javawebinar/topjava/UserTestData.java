...
public class UserTestData {
    ...
    public static final User user = new User(USER_ID, "User", "user@yandex.ru", "password", MealsUtil.DEFAULT_CALORIES_PER_DAY, true, new Date(), List.of(Role.USER));
    public static final User user_with_meals =
            new User(USER_ID, "User", "user@yandex.ru", "password",
                    MealsUtil.DEFAULT_CALORIES_PER_DAY, true, new Date(), List.of(Role.USER), MealTestData.meals);
